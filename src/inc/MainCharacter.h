...
enum Skills {SKILL_NONE, ADMINISTER, CONNECT, DRIVE, EXERT, FIX, HEAL, KNOW, LEAD, NOTICE, PERFORM, PROGRAM, PUNCH, SHOOT, SNEAK, STAB, SURVIVE, TALK, TRADE, WORK};

enum Backgrounds {BACKGROUND_NONE, BUM, BUREAUCRAT, CLERGY, CODER, CORP_SECURITY, CORPER, CRIMINAL, DOCTOR, DRONE_JOCKEY, GANGER, LABORER, LAW_ENFORCEMENT, MANAGER, OUTLANDER, PERFORMER, SOLDIER, SPY, TRADER, STREETWALKER, TECHNICIAN};

enum Edges {EDGE_NONE, EDUCATED, FACE, FOCUSED, GHOST, HACKER, HARD_TO_KILL, MASTERFUL_EXPERTISE, ON_TARGET, PRODIGY_STR, PRODIGY_DEX, PRODIGY_CON, PRODIGY_INT, PRODIGY_WIS, PRODIGY_CHA, OPERATORS_FORTUNE, VETERANS_LUCK, VOICE_OF_THE_PEOPLE, WIRED};

enum Foci {FOCI_NONE, ACE_DRIVE1, ACE_DRIVER2, ALERT1, ALERT2, ALL_NATURAL, ARMSMASTER1, ARMSMASTER2, ASSASSIN1, ASSASSIN2, AUTHORITY1, AUTHORITY2, CLOSE_COMBATANT1, CLOSE_COMBATANT2, CYBERDOC1, CYBERDOC2, DEADEYE1, DEADEYE2, DIPLOMAT1, DIPLOMAT2, DRONE_PILOT1, DRONE_PILOT2, EXPERT_PROGRAMMER1, EXPERT_PROGRAMMER2, HEALER1, HEALER2, HENCHKEEPER1, HENCHKEEPER2, MANY_FACES, POP_IDOL1, POP_IDOL2, ROAMER1, ROAMER2, SAFE_HAVEN1, SAFE_HAVEN2, SHOCKING_ASSAULT1, SHOCKING_ASSAULT2, SNIPERS_EYE1, SNIPERS_EYE2, SPECIALIST1, SPECIALIST2, TINKER1, TINKER2};
...
enum Main_Char_Tiles {PC_F_IDLE = 33, PC_F_WALK = 37, PC_B_IDLE = 41, PC_B_WALK = 45, PC_S_IDLE = 49, PC_S_WALK = 53};
